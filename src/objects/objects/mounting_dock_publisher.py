...
class MountingDockPublisher(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("position.x", 0.5)
        self.declare_parameter("position.y", 0.0)
        ...
        self.declare_parameter("color.r", 0.95)
        self.declare_parameter("color.g", 0.25)
        self.declare_parameter("color.b", 0.15)
